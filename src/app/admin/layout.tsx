    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      >
        <div className="p-6 flex items-center gap-3">
          ...
          {isSidebarOpen && (
            <span className="font-black tracking-tighter text-xl">Insight<span className="text-brand-primary">Matrix</span></span>
          )}
        </div>
        ...
        <div className="p-4 border-t border-white/5">
          <button className="flex items-center gap-4 px-4 py-3 w-full text-gray-400 hover:text-red-400 transition-colors uppercase text-[10px] font-black tracking-widest">
            <LogOut size={18} />
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between mb-10">
                <span className="font-black tracking-tighter text-2xl">Insight<span className="text-brand-primary">Matrix</span></span>
          ...
          <div className="flex items-center gap-4">
             ...
             <div className="flex items-center gap-3 pl-2">
                <div className="text-right hidden sm:block">
                   <div className="text-sm font-black text-gray-900 leading-none mb-1">Admin User</div>
                   <div className="text-[10px] font-black text-brand-primary uppercase tracking-widest">Super Admin</div>
                </div>
