  ...
  return (
    <div className="space-y-10">
      <div>
        ...
        <p className="text-gray-500 font-medium">Welcome back, Adnan. Here's what's happening today.</p>
      </div>
          ...
          >
            <div className="flex justify-between items-start mb-6">
              ...
              <div className={`flex items-center gap-1 text-[10px] font-black uppercase tracking-widest ${stat.isUp ? "text-emerald-500" : "text-rose-500"}`}>
                {stat.change} {stat.isUp ? <ArrowUpRight size={14} /> : <ArrowDownRight size={14} />}
              </div>
            </div>
            <div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="overflow-x-auto -mx-2">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-gray-50">
                {[
                  { client: "Global-X Retail", topic: "Consumer Habit Audit", status: "Active", date: "2h ago" },
                  { client: "TechStream", topic: "B2B SaaS Penetration", status: "Pending", date: "5h ago" },
                  { client: "BioCorp", topic: "European Market Entry", status: "Completed", date: "1d ago" },
                  { client: "FinEdge", topic: "Wealth Management UX", status: "Review", date: "2d ago" },
                ].map((item, i) => (
                  <tr key={i} className="group hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-5">
                       <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${
                         ...
                         item.status === 'Review' ? 'bg-brand-primary/10 text-brand-primary' :
        ...
        <div className="space-y-8">
           <div className="p-8 rounded-[2.5rem] bg-gray-900 text-white shadow-2xl relative overflow-hidden">
              ...
              <h3 className="text-xl font-black mb-6 border-b border-white/5 pb-6">Platform Health</h3>
              <div className="space-y-8">
                 {[
