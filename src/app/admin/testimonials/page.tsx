...
const initialTestimonials = [
  {
    ...
    content:
      "InsightMatrix solutions help the world's most recognized brands, media owners and agencies research reality, using the biggest, most connected proprietary panel.",
    rating: 5,
    status: "Active",
    avatar: "S",
  },
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            >
              <div className="p-8 border-b border-gray-50 flex items-center justify-between bg-gray-50/50">
                ...
                <button
                  onClick={() => setIsModalOpen(false)}
                  className="w-10 h-10 rounded-2xl bg-white border border-gray-100 flex items-center justify-center text-gray-400 hover:text-gray-900 transition-all"
                >
                  <X size={20} />
                </button>
              </div>
              ...
              <div className="p-8 space-y-6 overflow-y-auto max-h-[70vh]">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <input
                      type="text"
                      placeholder="e.g. Global Brand Co."
                      className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl text-sm text-gray-900 placeholder:text-gray-500 outline-none focus:ring-2 focus:ring-brand-primary/10 transition-all"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <textarea
                    rows={4}
                    placeholder="InsightMatrix solutions help..."
              ...
              <div className="p-8 border-t border-gray-50 flex gap-4">
                <button
                  onClick={() => setIsModalOpen(false)}
                  className="flex-1 py-4 px-6 rounded-2xl border border-gray-100 text-gray-500 font-black text-sm hover:bg-gray-50 transition-all"
                >
                  Discard
                </button>
                <button className="flex-2 py-4 px-10 rounded-2xl bg-brand-primary text-white font-black text-sm shadow-xl shadow-brand-primary/20 hover:bg-brand-hover transition-all">
                  Publish Testimonial
                </button>
              </div>
            </motion.div>
