...
export default function DashboardHome() {
  ...
  return (
    <div className="space-y-6">
      {/* Hero Mission Banner */}
      <div className="relative rounded-2xl bg-gradient-to-br from-[#091428] via-[#0A1A38] to-[#061020] text-white p-5 sm:p-7 shadow-lg shadow-brand-primary/10 border border-slate-800/80 overflow-hidden">
        <div className="pointer-events-none absolute -right-16 -top-16 w-60 h-60 bg-brand-primary/20 rounded-full blur-3xl" />
        <div className="pointer-events-none absolute -bottom-16 left-1/3 w-52 h-52 bg-cyan-500/10 rounded-full blur-2xl" />

        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div className="max-w-2xl space-y-3">
            <div className="flex flex-wrap items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-full bg-brand-primary text-white text-[9px] font-black uppercase tracking-widest shadow-xs flex items-center gap-1.5">
                <Sparkles size={11} />
                Featured Research Mission
              </span>
              <span className="px-2.5 py-0.5 rounded-full bg-white/10 text-brand-light text-[9px] font-black uppercase tracking-wider backdrop-blur-sm border border-white/10 flex items-center gap-1">
                <Clock size={11} />
          ...
          <div className="shrink-0 flex flex-col sm:flex-row lg:flex-col gap-2.5">
            {featuredSurvey ? (
              ...
              <Link
                ...
                className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-brand-primary via-blue-600 to-indigo-600 text-white text-xs font-black uppercase tracking-wider inline-flex items-center justify-center gap-2 shadow-md shadow-brand-primary/25 hover:opacity-95 active:scale-95 transition-all text-center"
              >
            ...
            <Link
              ...
              className="px-5 py-2 rounded-xl bg-white/10 hover:bg-white/15 text-white text-[11px] font-bold uppercase tracking-wider text-center backdrop-blur-sm border border-white/10 transition-all"
            >
              Update Prescreen
            </Link>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
        ...
        <Link
          href={ROUTES.dashboard.surveys}
          className="p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-blue-50/90 via-indigo-50/40 to-white border border-blue-200/80 shadow-xs hover:shadow-md hover:shadow-blue-500/10 transition-all duration-200 flex flex-col justify-between group"
        >
          ...
          <div>
            <div className="text-[10px] font-black uppercase tracking-wider text-blue-900/80 mb-0.5">
              Available Studies
            </div>
            <div className="text-xl sm:text-2xl font-black text-blue-700 tabular-nums">
        ...
        <Link
          ...
          className="p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-amber-50/90 via-orange-50/40 to-white border border-amber-200/80 shadow-xs hover:shadow-md hover:shadow-amber-500/10 transition-all duration-200 flex flex-col justify-between group"
        >
          <div className="flex items-center justify-between mb-2.5">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-amber-500 to-orange-500 text-white flex items-center justify-center shadow-xs group-hover:scale-105 transition-transform">
              <Coins size={18} />
            </div>
          ...
          <div>
            <div className="text-[10px] font-black uppercase tracking-wider text-amber-900/80 mb-0.5">
              Points Balance
            </div>
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-emerald-50/90 via-teal-50/40 to-white border border-emerald-200/80 shadow-xs flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2.5">
          ...
          <div>
            <div className="text-[10px] font-black uppercase tracking-wider text-emerald-900/80 mb-0.5">
              Lifetime Earned
            </div>
        ...
        <Link
          href={ROUTES.dashboard.prescreen}
          className="p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-purple-50/90 via-violet-50/40 to-white border border-purple-200/80 shadow-xs hover:shadow-md hover:shadow-purple-500/10 transition-all duration-200 flex flex-col justify-between group"
        >
          <div className="flex items-center justify-between mb-2.5">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-purple-600 to-violet-600 text-white flex items-center justify-center shadow-xs group-hover:scale-105 transition-transform">
              <ShieldCheck size={18} />
            </div>
          ...
          <div>
            <div className="text-[10px] font-black uppercase tracking-wider text-purple-900/80 mb-0.5">
              Profile Status
            </div>
            <div className="text-xl sm:text-2xl font-black text-purple-700">100% Eligible</div>
          </div>
        </Link>
      </div>
      ...
      <div className="grid lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 space-y-4">
          <div className="flex items-center justify-between">
            ...
            >
              View All ({surveys.length}) <ChevronRight size={13} />
            </Link>
          </div>

          {loadingSurveys ? (
            <div className="p-8 text-center bg-white rounded-2xl border border-gray-100">
              <Loader2 className="w-7 h-7 animate-spin mx-auto text-brand-primary mb-2" />
              <p className="text-xs font-bold text-gray-400">Matching surveys to your profile...</p>
            </div>
          ) : surveys.length === 0 ? (
            <div className="p-8 text-center bg-white rounded-2xl border border-gray-100 shadow-xs space-y-2.5">
              <div className="w-10 h-10 rounded-xl bg-brand-subtle text-brand-primary flex items-center justify-center mx-auto">
                <Compass size={20} />
              </div>
              <h3 className="text-sm font-black text-gray-900">No Matched Surveys Right Now</h3>
              ...
              <Link
                href={ROUTES.dashboard.prescreen}
                className="inline-flex px-4 py-2 rounded-xl bg-brand-primary text-white text-xs font-black uppercase tracking-wider shadow-xs hover:bg-brand-hover transition-colors"
              >
                Update Profile
              </Link>
            </div>
            ...
            <div className="space-y-3">
              {surveys.slice(0, 5).map((survey) => {
                ...
                return (
                  <div
                    key={survey.id}
                    className="p-4 rounded-xl bg-white border border-gray-100 hover:border-brand-primary/30 hover:shadow-sm transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-3 group"
                  >
                    <div className="flex items-start gap-3 min-w-0">
                      <div className="w-10 h-10 rounded-lg bg-brand-subtle text-brand-primary flex items-center justify-center font-bold shrink-0 group-hover:scale-105 transition-transform">
                        <ClipboardList size={18} />
                      </div>
        ...
        <div className="lg:col-span-4 space-y-4">
          {/* Weekly Rewards Goal */}
          <div className="p-5 rounded-2xl bg-[#091428] text-white space-y-3.5 border border-slate-800 shadow-md relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-white/10 flex items-center justify-center text-brand-light">
                  <Target size={14} />
                </div>
                <h3 className="text-xs font-black tracking-tight">Weekly Goal</h3>
              </div>
              <span className="text-[9px] font-black text-brand-light bg-white/10 px-2 py-0.5 rounded-full uppercase">
                Tier Bonus
              </span>
            </div>
            ...
            <div className="relative z-10 space-y-1.5">
              <div className="flex justify-between items-baseline">
                <span className="text-xl font-black text-white tabular-nums">
                  ...
                  <span className="text-[11px] font-bold text-slate-400">/ 5,000 pts</span>
                </span>
          ...
          <div className="p-4 rounded-xl bg-white border border-gray-100 shadow-xs flex items-center gap-3">
