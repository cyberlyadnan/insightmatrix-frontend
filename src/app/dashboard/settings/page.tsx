        ...
        <div className="lg:col-span-8 space-y-6">
            ...
            {[
              {
                ...
                desc: "Update your name, email, and location",
                icon: User,
              },
              {
              ...
              },
              {
                ...
                desc: "Manage passwords and two-factor auth",
                icon: Shield,
              },
              {
              ...
              <div
                key={i}
                className="p-6 md:p-8 flex items-center justify-between group cursor-pointer hover:bg-gray-50/50 transition-colors"
              >
          ...
          <div className="p-6 md:p-8 bg-rose-50 rounded-[2rem] md:rounded-[2.5rem] border border-rose-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="min-w-0">
              ...
              <p className="text-[10px] md:text-xs font-medium text-rose-400">
                Permanently remove your data and earnings.
              </p>
            </div>
