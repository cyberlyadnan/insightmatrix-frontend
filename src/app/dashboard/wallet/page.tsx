      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-gray-500 font-medium">
            Manage your earnings and redemption milestones.
          </p>
        </div>
              ...
              <div className="hidden sm:flex col-span-2 justify-end items-end">
                <div className="flex -space-x-3">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full border-2 border-brand-primary bg-white/20 backdrop-blur-md flex items-center justify-center text-[10px] font-black shrink-0"
                    >
        ...
        <div className="p-10 rounded-[3rem] bg-white border border-gray-100 flex flex-col justify-between group cursor-pointer hover:border-brand-primary/20 transition-all">
          <div>
            ...
            <p className="text-xs font-bold text-gray-400 leading-relaxed">
              Earn 750 more XP to unlock the <span className="text-brand-primary">Black Tier</span>{" "}
      ...
      <div className="grid lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="bg-white rounded-[2.5rem] border border-gray-100 divide-y divide-gray-50 overflow-hidden">
            {transactions.map((tx) => (
              ...
              >
                ...
                <div className="flex sm:flex-col items-center sm:items-end justify-between w-full sm:w-auto pt-3 sm:pt-0 border-t sm:border-t-0 border-gray-50">
                  <p
                    className={`text-sm font-black ${tx.amount.startsWith("+") ? "text-emerald-500" : "text-gray-900"}`}
                  >
                    {tx.amount}
                  </p>
            ...
            <button className="w-full py-4 text-[10px] font-black uppercase tracking-widest text-gray-400 hover:text-brand-primary transition-colors">
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={i}
                className="p-6 rounded-[2rem] bg-white border border-gray-100 flex items-center justify-between hover:shadow-xl hover:shadow-gray-200/40 transition-all cursor-pointer group"
              >
