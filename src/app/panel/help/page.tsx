    ...
    <div className="space-y-12">
      ...
      <div className="relative p-8 md:p-12 lg:p-20 rounded-[2.5rem] md:rounded-[4rem] bg-gray-950 text-white overflow-hidden">
         ...
         <div className="relative z-10 text-center max-w-2xl mx-auto">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black mb-6 md:mb-8 leading-tight">How can we <br />help you today?</h1>
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
         {categories.map((cat, i) => (
           ...
           >
              <div className={`w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-gray-50 flex items-center justify-center ${cat.color} mb-6 group-hover:scale-110 transition-transform`}>
                 <cat.icon size={24} className="md:w-7 md:h-7" />
              </div>
              <h3 className="text-lg md:text-xl font-black text-gray-900 mb-2">{cat.name}</h3>
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">{cat.count} Articles</p>
           </motion.div>
         ))}
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-10">
         <div className="p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] bg-brand-subtle/30 border border-brand-primary/5 flex flex-col justify-between">
            <div>
               <h2 className="text-xl md:text-2xl font-black text-gray-900 mb-6 font-black">Frequently Asked</h2>
               <div className="space-y-3 md:space-y-4">
                  {[
                    ...
                    <div key={i} className="p-4 md:p-5 rounded-xl md:rounded-2xl bg-white/50 border border-white/50 flex items-center justify-between hover:bg-white hover:shadow-md transition-all cursor-pointer group">
            ...
            <div className="p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] bg-white border border-gray-100 flex items-center justify-between shadow-sm hover:shadow-xl transition-all group cursor-pointer">
               <div className="flex items-center gap-4 md:gap-6 min-w-0">
                  ...
                  <div className="min-w-0">
                     ...
                     <p className="text-[10px] md:text-xs font-medium text-gray-500 truncate">Master the platform in 5 minutes.</p>
                  </div>
               </div>
               <ArrowRight size={20} className="text-gray-300 group-hover:text-brand-primary transition-all shrink-0" />
            </div>
