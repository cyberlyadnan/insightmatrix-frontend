    ...
    <div className="min-h-screen bg-slate-50 flex overflow-x-hidden">
      ...
      >
        ...
        <div className="p-6 mt-auto">
          ...
          <Link
            href="/panel/settings"
            className="flex items-center gap-4 px-5 py-4 w-full text-gray-400 hover:text-gray-900 transition-colors"
          >
            <Settings size={20} />
      ...
      <nav className="lg:hidden fixed bottom-4 left-6 right-6 h-18 bg-white/80 backdrop-blur-2xl border border-white/20 rounded-[1.5rem] shadow-2xl z-[100] px-8 flex items-center justify-between">
        ...
        <Link
          href="/panel/settings"
          className={`relative flex flex-col items-center gap-1 ${pathname === "/panel/settings" ? "text-brand-primary" : "text-gray-400"}`}
        >
          <UserCircle size={24} />
