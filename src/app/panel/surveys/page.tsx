...
const surveys = [
  { id: 1, title: "Next-Gen Smartphone Features", reward: "$6.50", time: "18m", category: "Technology", platform: "Mobile", rating: 4.8 },
  { id: 2, title: "Luxury Fashion Brand Audit", reward: "$15.00", time: "30m", category: "Fashion", platform: "Any", rating: 5.0 },
  { id: 3, title: "Daily Snacking Habits 2024", reward: "$2.20", time: "5m", category: "Consumer", platform: "Any", rating: 4.5 },
  { id: 4, title: "B2B SaaS Pricing Research", reward: "25.00", time: "45m", category: "Technology", platform: "Desktop", rating: 4.9 },
  { id: 5, title: "Urban Commuter Psychology", reward: "$8.40", time: "20m", category: "Lifestyle", platform: "Mobile", rating: 4.7 },
  { id: 6, title: "Ethical Skincare Preferences", reward: "$4.10", time: "10m", category: "Lifestyle", platform: "Any", rating: 4.6 },
];
           ...
           >
              ...
              <div className="space-y-4 mb-8">
                 ...
                 <div className="flex flex-wrap items-center gap-4">
                    ...
                    <div className="flex items-center gap-1.5 text-gray-400">
                       {survey.platform === 'Mobile' ? <Smartphone size={14} /> : survey.platform === 'Desktop' ? <Laptop size={14} /> : <Zap size={14} />}
              ...
              <div className="pt-6 border-t border-gray-50 flex items-center justify-between">
                 <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">{survey.category}</span>
