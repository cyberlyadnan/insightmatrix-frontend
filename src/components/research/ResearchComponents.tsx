  ...
  return (
    <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-gray-950">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-brand-accent2/20 rounded-full blur-[120px] animate-pulse" />
          ...
          <div className="flex-1">
            ...
            >
              ...
              <p className="text-gray-400 text-lg md:text-xl font-medium max-w-2xl leading-relaxed mb-10">
                Explore our deep-dive case studies and market reports. We transform millions of data
                points into actionable intelligence for global innovators.
              </p>
    ...
    >
      ...
      >
        ...
        <div className="p-8">
          ...
          <p className="text-gray-500 text-sm leading-relaxed mb-8 line-clamp-2">{study.excerpt}</p>
